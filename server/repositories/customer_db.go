...
func (r customerRepositoryDB) Signin(username string) (user Customer, err error) {
	...
	if err != nil {
		return user, fiber.NewError(fiber.StatusNotFound, "Incorrect username or password")
	}
